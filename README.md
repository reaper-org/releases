...
|---------|-------------|-------|
| [0.1.2](macos/arm64/v0.1.2/RELEASE_NOTES.md) | [DMG](macos/arm64/v0.1.2/reaper-0.1.2-macos-arm64.dmg) | Run UI, C/C++ navigation, CMake run, manifest & DB panels, editor regression (UI build 347) |
